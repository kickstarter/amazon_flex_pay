...
class RubyFPSPipelinesTest < RubyFPS::Test
  should "build a edit token pipeline" do
    ...
    assert_nothing_raised do
      params = RubyFPS.edit_token_pipeline('pipe1', :token_id => 'token').to_params('http://example.com/return')
    end
  end
  ...
  should "build a multi use pipeline" do
    params = nil
    assert_nothing_raised do
      params = RubyFPS.multi_use_pipeline('pipe2',
  ...
  should "build a recipient pipeline" do
    params = nil
    assert_nothing_raised do
      params = RubyFPS::recipient_pipeline('pipe3', :recipient_pays_fee => true).to_params('http://example.com/return')
    end
  end
  ...
  should "build a single use pipeline" do
    params = nil
    assert_nothing_raised do
      params = RubyFPS.single_use_pipeline('pipe4',
