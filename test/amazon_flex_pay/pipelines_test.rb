...
class AmazonFlexPay::PipelinesTest < AmazonFlexPay::Test
  should "build a edit token pipeline" do
    client.expects(:cbui).with do |pipeline|
    ...
    client.edit_token_pipeline('pipe1', 'http://example.com/return',
      :token_id => 'token'
    )
  end
  ...
  should "build a multi use pipeline" do
    ...
    client.multi_use_pipeline('pipe2', 'http://example.com/return',
  ...
  should "build a recipient pipeline" do
    ...
    client.recipient_pipeline('pipe3', 'http://example.com/return',
  ...
  should "build a single use pipeline" do
    ...
    client.single_use_pipeline('pipe4', 'http://example.com/return',
