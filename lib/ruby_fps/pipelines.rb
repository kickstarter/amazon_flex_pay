...
module RubyFPS
  class << self
    ...
    def edit_token_pipeline(caller_reference, options = {})
      RubyFPS::Pipelines::EditToken.new(options.merge(:caller_reference => caller_reference))
    end
    ...
    def multi_use_pipeline(caller_reference, options = {})
      RubyFPS::Pipelines::MultiUse.new(options.merge(:caller_reference => caller_reference))
    end
    ...
    def recipient_pipeline(caller_reference, options = {})
      RubyFPS::Pipelines::Recipient.new(options.merge(:caller_reference => caller_reference))
    end
    ...
    def single_use_pipeline(caller_reference, options = {})
      RubyFPS::Pipelines::SingleUse.new(options.merge(:caller_reference => caller_reference))
    end
  end
end
